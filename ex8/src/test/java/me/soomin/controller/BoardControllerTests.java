...
@ContextConfiguration({ "file:src/main/webapp/WEB-INF/spring/root-context.xml",
		"file:src/main/webapp/WEB-INF/spring/appServlet/servlet-context.xml" }) // Spring MVC 설정파일도 같이 로딩
...
public class BoardControllerTests {
	...
	@Before // 항상 테스트 전에 실행
	public void setup() {
		this.mockMvc = MockMvcBuilders.webAppContextSetup(ctx).build();// MockMvcBuilders 의 정적메서드 webAppContextSetup 으로
																		// 가짜 webAppCtx 객체를 만들고 MockMvc 객체로 만든다.
	}

//	@Test
	public void testList() throws Exception {
		log.info(mockMvc.perform(MockMvcRequestBuilders.get("/board/list"))// 가짜 Request를 .get 방식으로 보내고,
				.andReturn()// 리턴값을받아
...
//	@Test
	public void testModify() throws Exception {
		String resultPage = mockMvc
				.perform(MockMvcRequestBuilders.post("/board/modify").param("bno", "2").param("title", "수정된 테스트 새글 제목")
...
//	@Test
	...
	@Test
	public void testWithPaging() throws Exception {
